...
public class Calcul {
     ...
     * @return un entier égal  à la somme des 2 opérandes
     */
    public int ajouter() {
     ...
     * @return un entier égal  à la multiplication des 2 opérandes
     */
     ...
     * @return un entier égal  à la division entière opGauche / opDroite
