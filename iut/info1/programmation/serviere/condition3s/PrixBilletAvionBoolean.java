 ...
 */
public class PrixBilletAvionBoolean {
            ...
            if (0 < ageVoyageur && ageVoyageur < 115) {
                if (0 < prixBilletHR) {
                    if (ageVoyageur < 26 && prixBilletHR < 200) {
                        reductionAccorde = prixBilletHR * 
                                            REDUCTION_MOINS_SEIZE_MOINS_200E;
                    } else if (ageVoyageur < 26 && prixBilletHR >= 200) {
                        reductionAccorde = prixBilletHR * 
                                            REDUCTION_MOINS_SEIZE_PLUS_200E;
                    } else if (ageVoyageur >= 26 && prixBilletHR >= 300) {
                        reductionAccorde = prixBilletHR * 
                                            REDUCTION_PLUS_SEIZE_PLUS_300E;
                    } else {
